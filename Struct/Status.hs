...
instance CollectParams EvalWeights where
    ...
    npColInit = EvalWeights {
          ...
          ewKingPlacePwns   = tme 0 51,		-- after 204 steps with evbig.cfg
          ...
          ewCenterPAtts     = tme 62 74,		-- after 204 steps with evbig.cfg
          ewCenterNAtts     = tme 52 48,
          ewCenterBAtts     = tme 60 41,
          ewCenterRAtts     = tme 11 36,
          ewCenterQAtts     = tme  4 62,
          ewCenterKAtts     = tme  0 56,
          ewAdvAtts         = tme  7  8,		-- after 204 steps with evbig.cfg
          ewIsolPawns       = tme (-32) (-121),		-- after 204 steps with evbig.cfg
          ewIsolPassed      = tme (-62) (-132),		-- after 204 steps with evbig.cfg
          ewBackPawns       = tme (-103) (-192),		-- after 204 steps with evbig.cfg
          ewBackPOpen       = tme (-22)  (-5),		-- after 204 steps with evbig.cfg
          ...
          ewRookPawn        = tme (-45) (-30),		-- after 204 steps with evbig.cfg
          ewAdvPawn5        = tme    9  145,		-- after 204 steps with evbig.cfg
          ewAdvPawn6        = tme  418  513,		-- after 204 steps with evbig.cfg
          ewPawnBlockP      = tme (-121)(-110),		-- after 204 steps with evbig.cfg
          ewPawnBlockO      = tme (-20) (-21),		-- after 204 steps with evbig.cfg
          ewPawnBlockA      = tme (-16) (-75),		-- after 204 steps with evbig.cfg
          ewPassPawnLev     = tme 2 9		-- after 204 steps with evbig.cfg
        }
